...
contract Defaults {
    ...
    function setAssets(ERC20 _usdc, ERC20 _weth, ERC20 _wbtc) public {
        ...
        weth = _weth;
        wbtc = _wbtc;
        usdcDepositQuantity = Commons.convertFromE18(usdcDepositQuantityE18, usdc.decimals());
    }
    ...
    function usdcProduct() external view returns (Structs.Product memory) {
        return Structs.Product(1, address(usdc), address(usdc), true, 5e16, 3e16, false);
    }

    function wethProduct() external view returns (Structs.Product memory) {
        return Structs.Product(1, address(weth), address(usdc), true, 5e16, 3e16, false);
    }

    function wbtcProduct() external view returns (Structs.Product memory) {
        return Structs.Product(1, address(wbtc), address(usdc), true, 5e16, 3e16, false);
    }

    function wethUsdcPerpProduct() external view returns (Structs.Product memory) {
    ...
    function wbtcUsdcPerpProduct() external view returns (Structs.Product memory) {
        return Structs.Product(
            2,
            address(wbtc),
            address(usdc),
    ...
    function usdcRiskWeights() external pure returns (Structs.ProductRiskWeights memory) {
        return Structs.ProductRiskWeights(
            1000000000000000000, 1000000000000000000, 1000000000000000000, 1000000000000000000
        );
    }

    function wethRiskWeights() external pure returns (Structs.ProductRiskWeights memory) {
        return Structs.ProductRiskWeights(
    ...
    function wbtcRiskWeights() external pure returns (Structs.ProductRiskWeights memory) {
        return Structs.ProductRiskWeights(
            800000000000000000, // initialLongweight 0.8
            1200000000000000000, // initialShortWeight 1.2
            900000000000000000, // maintenanceLongWeight 0.9
    ...
    function wethUsdcPerpRiskWeights() external pure returns (Structs.ProductRiskWeights memory) {
        return Structs.ProductRiskWeights(
    ...
    function wbtcUsdcPerpRiskWeights() external pure returns (Structs.ProductRiskWeights memory) {
        return Structs.ProductRiskWeights(
            900000000000000000, // initialLongweight 0.9
            1100000000000000000, // initialShortWeight 1.1
            950000000000000000, // maintenanceLongWeight 0.95
    ...
    function wbtcSpreadPenalty() external pure returns (Structs.SpreadPenalties memory) {
        return Structs.SpreadPenalties(
            20000000000000000, // 0.02 initial
            10000000000000000 // 0.01 maintenance
        );
    }

    function wethSpreadPenalty() external pure returns (Structs.SpreadPenalties memory) {
        return Structs.SpreadPenalties(
    ...
    function assetRiskWeights() external pure returns (Structs.ProductRiskWeights memory) {
        return Structs.ProductRiskWeights(
    ...
    {
        return PerpMaintenanceMarginDirectivePositionTemplate(
            34e18,
    ...
    {
        return PerpInitialMarginDirectivePositionTemplate(
            87162e16,
